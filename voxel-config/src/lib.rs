...
//! [`frr`] (customer-router `frr.conf`, unnumbered BGP), [`mgs`]/[`sp`] (the
//! switch-zone MGS-sim + sp-sim configs), and [`rss`] (the RSS
//! `config-rss.toml`).
...
pub use config::{
    ...
    SLED_SERIAL_PREFIX, ServicePoolSchema, SledDataLinksSchema, SledDesc, SledDisksSchema, SpCfg,
    Topology, UplinkCfg, UplinkPort, VoxelConfig,
};
pub use frr::{FrrNeighbor, FrrRouter, StaticUplink};
pub use rss::RssConfigError;
