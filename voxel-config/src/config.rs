...
pub struct SpCfg {
    ...
    /// fetches voxel's pinned buildomat build into ~/.cache/voxel.
    pub emu_bin: Option<String>,
    /// faux-mgs binary override; fetched pinned like sp-emu when unset. The
    /// operator `sp` commands need it, launch itself does not.
