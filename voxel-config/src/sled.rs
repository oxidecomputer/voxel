...
impl SledAgentConfig {
    ...
    pub fn render(&self) -> String {
        ...
        writeln!(o, "# Sled Agent configuration - generated by voxel (g{i}).").unwrap();
        writeln!(o).unwrap();
...
mod tests {
    ...
    fn scrimlet_softnpu_ports_scale_with_sled_count() {
        ...
        let v = parse(&SledAgentConfig::new(0, true).with_topology(6, 2).render());
