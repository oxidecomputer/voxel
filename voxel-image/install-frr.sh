#!/bin/bash
#
# install-frr.sh - bootstrap shim for the voxel-frr image build.
#
# The install logic now lives in the agent: `voxel-init install --role frr`.
...
exec /tmp/voxel-init install --role frr
